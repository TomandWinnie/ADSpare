...
/*
 * 视频可以开始播放,该回调调用后可以调用showVideoWithController:展示视频广告
 */
...
@property (nonatomic, assign) BOOL enableSoundSetting; //是否使用SDK内部声音设置,默认YES(当游戏音效受影响时,关闭此设置)
